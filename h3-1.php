    ...
    <html>
        ...
        <body>
                ...
                <div class="button-blok">
                    <button  onclick="window.location.href='h3-1.php'" class="button-b active">BLOK 1</button>
                ...
                <div class="row">
                    <div class="column" style="background-color:#f7f7f6;">
                        <div class="kiri-1">
                                ...
                                <br>
                                <p>Kelembapan rata-rata tanaman Vanili di Blok 2</p>
                        ...
                        <div class="kiri-2">
                            <h4 class="temp">
                                ...
                                <br>
                                <p>Suhu rata-rata tanaman Vanili di Blok 2</p>
